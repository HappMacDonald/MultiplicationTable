...
var BrianHicks$elm_particle$Particle$System$emitterParticles = F3(
	function (delta, emitters, _n0) {
		var seed = _n0.a.seed;
		return A3(
			elm$core$List$foldl,
			F2(
				function (emitter, _n1) {
					var particles = _n1.a;
					var curSeed = _n1.b;
					return A2(
...
var BrianHicks$elm_particle$Particle$System$sub = F3(
	function (emitters, msg, outer) {
		...
		return (elm$core$List$isEmpty(emitters) && elm$core$List$isEmpty(system.particles)) ? elm$core$Platform$Sub$none : elm$browser$Browser$Events$onAnimationFrameDelta(
			function (delta) {
				var _n0 = A3(BrianHicks$elm_particle$Particle$System$emitterParticles, delta, emitters, outer);
				var particles = _n0.a;
				var seed = _n0.b;
				return msg(
...
var author$project$Confetti$MouseMove = F2(
	function (a, b) {
		return {$: 'MouseMove', a: a, b: b};
	});
var author$project$Confetti$ParticleMsg = function (a) {
	return {$: 'ParticleMsg', a: a};
};
var author$project$Confetti$TriggerBurst = {$: 'TriggerBurst'};
var BrianHicks$elm_particle$Particle$System$burst = F2(
	function (generator, _n0) {
		var system = _n0.a;
		var _n1 = A2(elm$random$Random$step, generator, system.seed);
		var particles = _n1.a;
		var nextSeed = _n1.b;
		return BrianHicks$elm_particle$Particle$System$System(
			_Utils_update(
...
var BrianHicks$elm_particle$Particle$update = F2(
	function (deltaMs, _n0) {
		...
		var dragAtVelocity = function (v) {
			return ((((drag.coefficient * drag.area) * 0.5) * drag.density) * v) * v;
		};
		var deltaSeconds = deltaMs / 1000;
		var applyDrag = function (v) {
			return (v > 0) ? (v - (dragAtVelocity(v) * deltaSeconds)) : (v + (dragAtVelocity(
				elm$core$Basics$abs(v)) * deltaSeconds));
		};
		var _n1 = velocity;
		var velocityX = _n1.a;
		var velocityY = _n1.b;
		...
		var positionX = _n2.a;
		var positionY = _n2.b;
		var _n3 = acceleration;
		var accelerationX = _n3.a;
		var accelerationY = _n3.b;
		return (lifetime < 0) ? elm$core$Maybe$Nothing : A2(elm$core$Basics$composeL, elm$core$Maybe$Just, BrianHicks$elm_particle$Particle$Particle)(
			{
				...
				position: _Utils_Tuple2((positionX + (velocityX * deltaSeconds)) + (((accelerationX * deltaSeconds) * deltaSeconds) / 2), (positionY + (velocityY * deltaSeconds)) + (((accelerationY * deltaSeconds) * deltaSeconds) / 2)),
				velocity: _Utils_Tuple2(
					applyDrag(velocityX + (accelerationX * deltaSeconds)),
					applyDrag(velocityY + (accelerationY * deltaSeconds)))
			});
	});
		...
		function (angle, _n0) {
			...
			return BrianHicks$elm_particle$Particle$Particle(
				_Utils_update(
					particle,
					{
						velocity: elm$core$Basics$fromPolar(
							A2(
								elm$core$Tuple$mapSecond,
								function (_n1) {
									return angle - elm$core$Basics$degrees(90);
								},
								elm$core$Basics$toPolar(particle.velocity)))
					}));
		}));
		...
		function (position, _n0) {
			...
			return BrianHicks$elm_particle$Particle$Particle(
				_Utils_update(
					particle,
					{
						position: _Utils_Tuple2(position.x, position.y)
					}));
		}));
...
var author$project$Confetti$genSquare = A4(
...
var author$project$Confetti$genStreamer = A3(
	...
	A2(
		...
		A2(elm_community$random_extra$Random$Float$normal, 25, 10)));
...
var author$project$Confetti$genConfetti = A2(
	elm_community$random_extra$Random$Extra$frequency,
	_Utils_Tuple2(5 / 8, author$project$Confetti$genSquare),
	_List_fromArray(
		[
					...
					A2(
						...
						A2(
							...
							A2(
								...
								BrianHicks$elm_particle$Particle$init(author$project$Confetti$genConfetti)))))));
	});
...
var author$project$Confetti$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'TriggerBurst':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								elm$core$Task$perform,
								function (_n1) {
									return author$project$Confetti$BurstAtMouse;
								},
						...
						model,
						{
							system: A2(
								...
								A2(
									...
									25,
									A2(author$project$Confetti$particleAt, x, y)),
								model.system)
						}),
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							system: A2(BrianHicks$elm_particle$Particle$System$update, particleMsg, model.system)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var BrianHicks$elm_particle$Particle$System$view = F3(
	function (viewParticle, attrs, _n0) {
		var particles = _n0.a.particles;
		return A2(
			elm$svg$Svg$svg,
			attrs,
			A2(
...
var BrianHicks$elm_particle$Particle$data = function (_n0) {
	var particle = _n0.a;
	return particle.data;
};
var BrianHicks$elm_particle$Particle$direction = function (_n0) {
	var velocity = _n0.a.velocity;
	return elm$core$Basics$toPolar(velocity).b;
};
...
var BrianHicks$elm_particle$Particle$lifetimePercent = function (_n0) {
	var lifetime = _n0.a.lifetime;
	var originalLifetime = _n0.a.originalLifetime;
...
var author$project$Confetti$viewConfetti = function (particle) {
	var lifetime = BrianHicks$elm_particle$Particle$lifetimePercent(particle);
	var opacity = (lifetime < 0.1) ? (lifetime * 10) : 1;
	var _n0 = BrianHicks$elm_particle$Particle$data(particle);
	if (_n0.$ === 'Square') {
		var color = _n0.a.color;
		var rotationOffset = _n0.a.rotationOffset;
		var rotations = _n0.a.rotations;
		return A2(
			elm$svg$Svg$rect,
			_List_fromArray(
				[
					...
					author$project$Confetti$fill(color)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$core$String$fromInt(length) + 'px'),
					elm$svg$Svg$Attributes$y('-5px'),
					elm$svg$Svg$Attributes$rx('2px'),
					elm$svg$Svg$Attributes$ry('2px'),
					elm$svg$Svg$Attributes$fill(
...
var author$project$Confetti$view = function (model) {
	var _n0 = model.mouse;
	var mouseX = _n0.a;
	var mouseY = _n0.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Confetti$viewConfetti,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$src('tada.png'),
						elm$html$Html$Attributes$width(64),
						elm$html$Html$Attributes$height(64),
						elm$html$Html$Attributes$alt('\"tada\" emoji from Mutant Standard'),
						A2(elm$html$Html$Attributes$style, 'position', 'absolute'),
						A2(
						elm$html$Html$Attributes$style,
						'left',
						elm$core$String$fromFloat(mouseX - 20) + 'px'),
						A2(
						elm$html$Html$Attributes$style,
						'top',
						elm$core$String$fromFloat(mouseY - 30) + 'px'),
...
var author$project$Confetti$main = elm$browser$Browser$element(
	{
		init: function (_n0) {
			return _Utils_Tuple2(
				{
					mouse: _Utils_Tuple2(0, 0),
					system: BrianHicks$elm_particle$Particle$System$init(
		...
		subscriptions: function (model) {
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						A3(BrianHicks$elm_particle$Particle$System$sub, _List_Nil, author$project$Confetti$ParticleMsg, model.system),
						elm$browser$Browser$Events$onClick(
						elm$json$Json$Decode$succeed(author$project$Confetti$TriggerBurst)),
						elm$browser$Browser$Events$onMouseMove(
						A3(
							elm$json$Json$Decode$map2,
							author$project$Confetti$MouseMove,
							A2(elm$json$Json$Decode$field, 'clientX', elm$json$Json$Decode$float),
							A2(elm$json$Json$Decode$field, 'clientY', elm$json$Json$Decode$float)))
					]));
		},
		update: author$project$Confetti$update,
		view: author$project$Confetti$view
	});
_Platform_export({'Confetti':{'init':author$project$Confetti$main(
