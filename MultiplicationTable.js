...
var author$project$MultiplicationTable$OnEntry = F3(
	function (a, b, c) {
		return {$: 'OnEntry', a: a, b: b, c: c};
	});
var author$project$MultiplicationTable$Reset = {$: 'Reset'};
				...
				_Utils_ap(
																	...
																	function (colNum, cell) {
																		switch (colNum) {
																			...
																			default:
																				...
																				var indicatorColor = A2(
																					elm$core$Debug$log,
																					'indicatorColor',
																					_Utils_eq(
																						A2(elm$core$Debug$log, 'cellNum', cellNum),
																						A2(elm$core$Debug$log, 'row x col', rowNum * colNum)) ? author$project$MultiplicationTable$correctColor : author$project$MultiplicationTable$incorrectColor);
																				return A2(
																					mdgriffith$elm_ui$Element$el,
																					_List_fromArray(
																						[
																					...
																					A2(
																							...
																							]),
																						{
																							...
																							onChange: A2(author$project$MultiplicationTable$OnEntry, rowNum, colNum),
					...
					_List_fromArray(
						[
							...
							{
								label: mdgriffith$elm_ui$Element$text('Start all over?'),
								onPress: elm$core$Maybe$Just(author$project$MultiplicationTable$Reset)
							})
						])))));
};
var author$project$MultiplicationTable$Model = function (a) {
	return {$: 'Model', a: a};
};
...
var author$project$MultiplicationTable$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$MultiplicationTable$Model(
			A2(
				elm$core$Array$repeat,
				10,
				A2(elm$core$Array$repeat, 10, elm$core$Maybe$Nothing))),
		...
		switch (msg.$) {
			case 'OnEntry':
				...
				var rowOld = A2(
					elm$core$Maybe$withDefault,
					A2(elm$core$Array$repeat, 10, elm$core$Maybe$Nothing),
					A2(elm$core$Array$get, rowNum, modelRows));
				var cellOld = A2(
					elm$core$Maybe$withDefault,
					elm$core$Maybe$Nothing,
...
var author$project$MultiplicationTable$main = elm$browser$Browser$element(
	{init: author$project$MultiplicationTable$init, subscriptions: author$project$MultiplicationTable$subscriptions, update: author$project$MultiplicationTable$update, view: author$project$MultiplicationTable$body});
